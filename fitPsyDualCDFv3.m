function [threshold,beta,muLower,sigmaLower] = fitPsyDualCDFv3(varargin)
%% README
...
paramLB      =[1            1               1          1               0                  0                        0];
paramUB      =[25           15              25         15             .8                 .3                       .3];
...
% Return biasing (beta)
beta = beta; %total vertical displacement of curve at midpoint
