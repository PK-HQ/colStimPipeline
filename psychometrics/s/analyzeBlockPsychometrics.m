function [behavioralData]=...
    analyzeBlockPsychometrics(filenameStructCurrent, behavioralData, blockID, ...
...
if isfield(runData.TS.Header.Conditions, 'GaborSize')
    ...
    opto0 = contains(projectedImageConds, 'O00000') | contains(projectedImageConds, 'O04500');
    opto90 = contains(projectedImageConds, 'O09000') | contains(projectedImageConds, 'O13500');
