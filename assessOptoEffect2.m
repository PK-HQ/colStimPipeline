function [visualr,visualrRatios,PCAr,PCArRatios,optoIntensity]=assessOptoEffect2(dataStructReference,dataStructCurrent,columnarBitmapCoregistered,columnarPCAsCoregistered,saveFlag)
%% Get filenames
