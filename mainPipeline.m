        ...
        case {'psycluster'}
            ...
            if plotFlag
                ...
                if isfield(mdlStruct, sourceMdlField)
                    ...
                    relevanceOpts.makeFigures = plotFlag || saveFlag;
                    ...
                    if saveFlag
                        ...
                        if saveFlag
                            ...
                            nRelevanceFiguresToStage = nCreatedRelevanceFigures;
...
function latestPageFile = getLatestReportPageFile(reportState)
    ...
    latestPageFile = reportState.localPdf;
end
