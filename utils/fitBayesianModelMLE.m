...
%   mdlAvg - Structure with fitted model to average data across blocks
    ...
    initialModelOptions = struct('nTrials', 1000, 'useGPU', true, 'smartAllocation', true, 'verbose', false);
    fullModelOptions = struct('nTrials', 5000, 'useGPU', true, 'smartAllocation', true, 'verbose', false);
