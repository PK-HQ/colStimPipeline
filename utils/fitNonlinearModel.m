function fitNonlinearModel(clusterPsy, predictors, predictorNames, method, includeInteractions, includeQuadratic, flagAnalyticalTools)
    % Fits a nonlinear model using Lasso or Elastic Net with interaction terms
    %
    % Args:
