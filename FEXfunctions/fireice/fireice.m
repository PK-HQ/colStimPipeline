function [colormapRB,colormapR,colormapB] = fireice(m)
...
colormapRB=colormapRB(midColormapRB-nColors:midColormapRB+nColors+1,:); %this is correct as midpoint is a whole number, fireice is 64 x 3 not 65 x 3 (without black midpoint)
midColormapRB=length(colormapRB)/2;

colormapR=[0 0 0; colormapRB(midColormapRB+1:end,:)]; %add zero = black
colormapB=[colormapRB(1:midColormapRB,:); 0 0 0]; %add zero = black
colormapRB=[colormapRB(1:nColors+1,:);0 0 0;colormapRB(nColors+2:end,:)];
end
